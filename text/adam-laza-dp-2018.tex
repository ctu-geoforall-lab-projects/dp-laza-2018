...
\newpage
\section{Docker}
Docker is a Linux container technology that allows package and ship applications and everything it needs to execute into a standard
...
some kind of virtualization. They differ in architecture, see Fig. \ref{fig:Docker_container} and \ref{fig:Docker_VM}.

\begin{figure}[h!]
\centering
\includegraphics[width=0.9\textwidth]{img/Docker_compare}
\caption{Container vs VM differences, source \url{https://blogs.msdn.microsoft.com/uk_faculty_connection/2016/09/23}}
\label{fig:Docker_compare}
\end{figure}

%\url{https://blogs.msdn.microsoft.com/uk_faculty_connection/2016/09/23}
