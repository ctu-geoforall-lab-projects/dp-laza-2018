...
public administration or industry. They work on several project and develop new technologies. Among their various projects there is 
...
ZOO-Project is the first and in this time probably only one implementation of the WPS 2.0.0 standard. \textit{GetCapabilities},
...
\todo[inline]{Doplnit ZOO-Project}

\subsection{GeoServer}
\todo[inline]{Doplnit geoserver}

\subsection{ArcGIS}
\todo[inline]{Doplnit ArcGIS}
