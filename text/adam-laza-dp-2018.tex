...
instalation was necessary. The newly-created Dockerfile is available at App. \ref{app:dockerfile}. At the end of the work on this thesis pywps-demo offers dockerfiles based on \textit{alpine} and \textit{ubuntu} Linux distribution.
...
diff is available at \ref{app:owslib}.
