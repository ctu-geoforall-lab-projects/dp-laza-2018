...
standardizing requests and response. It also defines how clients can
...
Services it implements also WPS standard 1.0.0. Their solution offers
...
public administration or industry. They work on several projects and
%% ML: nenajdes lepsi slovo nez specialization(s)?
develop new technolog ies. Among their various specialization there is
...
invocation with both HTTP-GET and HTTP-POST request. To store results
there is optional MapServer support. It is convenient to publish
...
%% ML: exposing ?
services, applications and data. It allows expose the analytic
capability of ArcGIS to web as a \textit{Geoprocessing service}. A
%%% ML: moc mi ta veta nedava smysl
geoprocessing service consists of one or more geoprocessing tasks which
is ArcGIS geoprocessing tool running on the server. It is possible to
